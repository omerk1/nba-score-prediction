...
- data/raw/                cached raw API responses (via http_utils/data_api)
- data/games.csv           one row per game (Step 3 + Step 3b columns)
- data/series/{slug}.parquet   full per-game unified price series
